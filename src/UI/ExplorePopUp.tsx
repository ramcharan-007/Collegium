...
const ExplorePopUp = ({ isOpen, onClose }: ExplorePopUpProps) => {
  ...
  const leftColumnLinks = [
    ...
    {
      icon: "📖",
      text: "Institute (Counselling, Coaching and More)",
      link: "#",
    },
                ...
                {rightColumnLinks.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      {item.badge && (
                        <span
                          className={`text-xs ${item.badgeColor} font-medium`}
                        >
                          {item.badge}
                        </span>
                      )}
          ...
          <div className="w-80 bg-linear-to-br from-amber-50 to-orange-100 p-6 rounded-r-lg flex flex-col items-center justify-center">
            <div className="text-center mb-4">
              ...
              <p className="text-xl font-bold">
                & Earn Upto{" "}
                <span className="text-orange-500 text-2xl">₹300"</span>
              </p>
            ...
            <div className="flex gap-1 mb-4">
              ...
              <svg className="w-8 h-8 fill-gray-300" viewBox="0 0 24 24">
                <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
              </svg>
            </div>
            ...
            <div className="relative">
              <div className="w-48 h-32 bg-white rounded-lg shadow-md p-4 flex items-center justify-center">
                ...
                >
                  ...
                  {/* Laptop Base */}
                  <path
                    d="M 10 110 L 20 110 L 20 115 L 160 115 L 160 110 L 170 110 L 175 125 L 5 125 Z"
                    fill="#9ca3af"
                    stroke="#6b7280"
                    strokeWidth="1"
                  />
